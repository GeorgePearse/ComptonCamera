...
class G4GeneralParticleSource; //NEW
class G4ParticleGun;
class G4Event;
class G4Box;
...
class B1PrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction //SAME
{
  public:
    ...
    const G4ParticleGun* GetParticleGun() const { return fParticleGun; } //KEPT
    const G4GeneralParticleSource* GetParticleGun2() const { return fParticleGun2; } //NEW
